...
const CITIES = [
  ...
  { name: "Cornwall", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Peterborough", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Belleville", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Kingston ON", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Guelph", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Brantford", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "St. Catharines", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Sault Ste. Marie", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Sarnia", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "North Bay", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Timmins", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Orillia", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Midland", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Collingwood", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Brockville", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Pembroke", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Stratford ON", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Woodstock ON", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Oshawa", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Ajax", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Pickering", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Whitby", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Newmarket", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Aurora ON", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Richmond Hill", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Markham", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Vaughan", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Burlington ON", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Oakville", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Mississauga", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Brampton", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Etobicoke", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Scarborough", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Waterloo ON", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Cambridge ON", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Chatham ON", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Leamington", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Trenton ON", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Cobourg", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Orangeville", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Huntsville ON", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Parry Sound", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Sturgeon Falls", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Kapuskasing", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Espanola", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Kenora", tz: "America/Winnipeg", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Fort Frances", tz: "America/Rainy_River", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Dryden ON", tz: "America/Winnipeg", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Welland", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Niagara Falls", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
  { name: "Niagara-on-the-Lake", tz: "America/Toronto", flag: "🇨🇦", region: "Americas", country: "CA" },
...
export default function WorldTimezone({ onPrivacy, onAbout }) {
  ...
  const searchGeoNames = async (query) => {
    ...
    setGeoError(false);
    try {
      // Try Canada-biased search first for better local results
      const res = await fetch(
        `https://secure.geonames.org/searchJSON?q=${encodeURIComponent(query)}&maxRows=15&featureClass=P&featureCode=PPL&featureCode=PPLA&featureCode=PPLA2&featureCode=PPLC&orderby=population&style=SHORT&username=docvault`
      );
